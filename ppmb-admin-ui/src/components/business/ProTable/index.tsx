...
export interface ProTableProps<T, U> extends Omit<
  AntdProTableProps<T, U>,
  "request"
> {
  queryKey?: string[];
  queryFn?: (
...
>(props: ProTableProps<T, U>) {
  ...
  const { isLoading } = useQuery({
    queryKey: queryKey
      ? [...queryKey, queryParams, sortParams, filterParams]
      : ["pro-table-query", queryParams, sortParams, filterParams],
    queryFn: async () => {
      if (queryFn) {
