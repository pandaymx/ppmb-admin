...
class DictTypeControllerTest {
  ...
  void setUp() {
    ...
    dictTypeDto.setId(1L);
    dictTypeDto.setDictName("用户状态");
    dictTypeDto.setDictType("user_status");
    dictTypeDto.setSystemFlag("N");
    dictTypeDto.setStatus(0);
    dictTypeDto.setRemark("用户状态字典");
  }
