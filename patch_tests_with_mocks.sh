cat << 'MOCK_TEST' > ppmb-common-redis/src/test/java/top/ppmblszdp/common/redis/util/RedisUtilMockTest.java
...
public class RedisUtilMockTest {
...
cat << 'MOCK_TEST' > ppmb-common-redis/src/test/java/top/ppmblszdp/common/redis/util/TwoLevelCacheMockTest.java
package top.ppmblszdp.common.redis.util;
...
public class TwoLevelCacheMockTest {
...
cat << 'MOCK_TEST' > ppmb-common-redis/src/test/java/top/ppmblszdp/common/redis/util/RedisRateLimiterMockTest.java
package top.ppmblszdp.common.redis.util;
...
public class RedisRateLimiterMockTest {
